...
$b_N\le1.3\times10^{-1}\%$、$b_T\le1.9\%$（后者来自 Adam 在 $\tau=0.99$
的有限步数未收敛，LP/statsmodels/sklearn/L-BFGS-B 四框架在每个 $\tau$ 均
逐位一致）。系数随 $\tau$ 的结构具有明确含义：
\begin{itemize}
\item $b_T$ 自 $\tau\ge0.8$ 起\textbf{单调递减}（$0.248\to0.089\to0.044$）：
